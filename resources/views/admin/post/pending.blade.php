                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Pending Posts List</h3>
                        </div>
                    </div>
                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="{{ route('admin.posts.deny',$post->id) }}" class="mr-1" method="POST">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-danger"> <i class="fas fa-trash"></i> </button>
                                            </form>
                                            <a href="{{ route('admin.posts.pending.details',$post->id) }}" class="btn btn-sm btn-success mr-1"> <i class="fas fa-eye"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                                @else
